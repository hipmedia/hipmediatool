...
const showPopupButton = document.getElementById('showPopupButton'); // Nút để kích hoạt pop-up

// Hàm hiển thị modal
function showModal(title = "Thông báo", message = "Đây là nội dung thông báo mặc định của bạn.") {
  document.getElementById('modalTitle').textContent = title;
  document.getElementById('modalMessage').textContent = message;
  customModal.style.display = 'flex'; // Sử dụng flex để căn giữa
}
...
// Lắng nghe sự kiện nhấp vào nút đóng (X)
...
// Lắng nghe sự kiện nhấp vào nút "Hiển thị thông báo" để mở pop-up
if (showPopupButton) {
  showPopupButton.addEventListener('click', () => {
    showModal("Chào mừng bạn!", "Cảm ơn bạn đã ghé thăm Tài Nguyên Media. Chúc bạn có một trải nghiệm tuyệt vời!");
  });
}

/* Kết thúc các hàm và sự kiện cho Modal Pop-up */